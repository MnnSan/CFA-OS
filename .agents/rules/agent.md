...
## Architecture Freeze (Sprint 6 onwards)

As of the completion of Sprint 6, the following core architecture modules are frozen:
- **Repository Layer** (`src/repositories/*`)
- **EventBus** (`src/services/EventBus.ts`)
- **Knowledge Graph & Validator** (`src/knowledge/*`)
- **Services** (`src/services/*`)
- **Snapshot** (`src/knowledge/GraphSnapshot.ts`)
- **Context** (`src/context/*`)

Do NOT modify these core directories or classes unless it is absolutely necessary for bug fixes or explicitly instructed by the user. All future development (such as AI Tutors or synchronization engines) should build purely on top of these established APIs and event channels.