...
export const DeveloperTools: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Dev Header */}
      <div className="flex flex-col space-y-1.5 border-b border-slate-200 pb-4 dark:border-neutral-700/50">
        <div className="flex items-center space-x-2">
          <Terminal className="h-5 w-5 text-indigo-500 animate-pulse" />
          <h1 className="text-xl font-bold tracking-tight text-slate-900 dark:text-neutral-50 font-sans">
      ...
      <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
        ...
        {/* Nodes Card */}
        <div className="bg-white p-4 rounded border border-slate-200 dark:border-neutral-700/50 dark:bg-neutral-800/60 shadow-xs flex items-center space-x-3.5">
          <Database className="h-5 w-5 text-indigo-500 shrink-0" />
          <div className="min-w-0">
            <span className="text-[9px] font-mono font-bold text-slate-400 dark:text-neutral-500 uppercase tracking-wider block">Graph Nodes</span>
            <span className="text-lg font-bold text-slate-800 dark:text-neutral-100">{knowledgeSnapshot.metadata.nodeCount}</span>
          </div>
        </div>
        ...
        <div className="bg-white p-4 rounded border border-slate-200 dark:border-neutral-700/50 dark:bg-neutral-800/60 shadow-xs flex items-center space-x-3.5">
          ...
          <div className="min-w-0">
            <span className="text-[9px] font-mono font-bold text-slate-400 dark:text-neutral-500 uppercase tracking-wider block">Graph Edges</span>
            <span className="text-lg font-bold text-slate-800 dark:text-neutral-100">{knowledgeSnapshot.metadata.edgeCount}</span>
          </div>
        </div>
        ...
        <div className="bg-white p-4 rounded border border-slate-200 dark:border-neutral-700/50 dark:bg-neutral-800/60 shadow-xs flex items-center space-x-3.5">
          ...
          <div className="min-w-0">
            <span className="text-[9px] font-mono font-bold text-slate-400 dark:text-neutral-500 uppercase tracking-wider block">Compile Speed</span>
            <span className="text-lg font-bold text-slate-800 dark:text-neutral-100">
        ...
        <div className="bg-white p-4 rounded border border-slate-200 dark:border-neutral-700/50 dark:bg-neutral-800/60 shadow-xs flex items-center space-x-3.5">
          ...
          <div className="min-w-0">
            <span className="text-[9px] font-mono font-bold text-slate-400 dark:text-neutral-500 uppercase tracking-wider block">JS Heap Memory</span>
            <span className="text-sm font-bold text-slate-800 dark:text-neutral-100 truncate block">{memoryUsage}</span>
          </div>
        </div>
      ...
      <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
        ...
        <div className="bg-white p-4 rounded border border-slate-200 dark:border-neutral-700/50 dark:bg-neutral-800/60 shadow-xs flex items-center space-x-3.5">
          ...
          <div className="min-w-0">
            <span className="text-[9px] font-mono font-bold text-slate-400 dark:text-neutral-500 uppercase tracking-wider block">Event Store</span>
            <span className="text-lg font-bold text-slate-800 dark:text-neutral-100">{eventStoreService.getBufferSize()}</span>
        ...
        <div className="bg-white p-4 rounded border border-slate-200 dark:border-neutral-700/50 dark:bg-neutral-800/60 shadow-xs flex items-center space-x-3.5">
          ...
          <div className="min-w-0">
            <span className="text-[9px] font-mono font-bold text-slate-400 dark:text-neutral-500 uppercase tracking-wider block">Search Index</span>
            <span className="text-lg font-bold text-slate-800 dark:text-neutral-100">{knowledgeIndexService.getIndexSize()}</span>
        ...
        <div className={`bg-white p-4 rounded border shadow-xs flex items-center space-x-3.5 ${
          isDegraded 
            ...
            : 'border-slate-200 dark:border-neutral-700/50'
        } dark:bg-neutral-800/60`}>
          <Shield className={`h-5 w-5 shrink-0 ${isDegraded ? 'text-amber-500' : 'text-green-500'}`} />
          <div className="min-w-0">
            <span className="text-[9px] font-mono font-bold text-slate-400 dark:text-neutral-500 uppercase tracking-wider block">Orchestrator</span>
        ...
        <div className="bg-white p-4 rounded border border-slate-200 dark:border-neutral-700/50 dark:bg-neutral-800/60 shadow-xs flex items-center space-x-3.5">
          ...
          <div className="min-w-0">
            <span className="text-[9px] font-mono font-bold text-slate-400 dark:text-neutral-500 uppercase tracking-wider block">Index Rebuild</span>
            <span className="text-[11px] font-bold text-slate-800 dark:text-neutral-100 truncate block">
      ...
      <div className="grid gap-6 md:grid-cols-3">
        ...
        <div className="space-y-6 md:col-span-1">
          ...
          <div className="bg-white p-5 rounded border border-slate-200 dark:border-neutral-700/50 dark:bg-neutral-800/60 shadow-xs">
            <h2 className="text-xs font-mono font-bold text-slate-900 dark:text-neutral-205 border-b border-slate-100 dark:border-neutral-850 pb-2.5 mb-4 uppercase tracking-widest">
              Mock Event Dispatcher
            </h2>
            <div className="space-y-2.5">
              <button
                onClick={handleTriggerMockNote}
                className="w-full flex items-center justify-between text-left p-2.5 border border-slate-200 dark:border-neutral-700/50 rounded bg-slate-50/50 hover:bg-slate-100 dark:bg-neutral-950/20 dark:hover:bg-neutral-850/50 transition-colors text-xs font-semibold cursor-pointer"
              >
                <div className="min-w-0">
                  <span className="font-mono text-[9px] text-indigo-500 block">EVENT: NoteCreated</span>
                  <span className="text-slate-800 dark:text-neutral-200">Inject Study Note Event</span>
                </div>
              ...
              >
                <div className="min-w-0">
                  ...
                  <span className="text-slate-800 dark:text-neutral-200">Inject Study Session Event</span>
                </div>
                <Play className="h-3 w-3 text-slate-450 shrink-0" />
              </button>
            </div>
          ...
          <div className="bg-white p-5 rounded border border-slate-200 dark:border-neutral-700/50 dark:bg-neutral-800/60 shadow-xs">
            ...
            <div className="space-y-3 text-xs">
              <div className="flex items-center justify-between font-mono">
                ...
                <span className={`font-bold ${knowledgeSnapshot.health.brokenLinks.length > 0 ? 'text-red-500' : 'text-slate-600 dark:text-neutral-300'}`}>
                  {knowledgeSnapshot.health.brokenLinks.length}
                </span>
              </div>
              <div className="flex items-center justify-between font-mono">
                <span className="text-slate-50">Orphan Vertices</span>
                <span className={`font-bold ${knowledgeSnapshot.health.orphanNodes.length > 0 ? 'text-amber-500' : 'text-slate-600 dark:text-neutral-300'}`}>
        ...
        <div className="md:col-span-2 space-y-4 flex flex-col bg-white border border-slate-200 dark:border-neutral-700/50 dark:bg-neutral-800/60 rounded p-5 shadow-xs">
          
          {/* Sub Navigation */}
          <div className="flex border-b border-slate-100 dark:border-neutral-850 pb-2 gap-4">
            <button
              onClick={() => setActiveSubTab('diagnostics')}
              className={`text-xs font-mono font-bold pb-2 border-b-2 tracking-wider uppercase transition-all cursor-pointer ${
                activeSubTab === 'diagnostics' 
                  ? 'border-indigo-500 text-slate-800 dark:text-neutral-200' 
          ...
          {activeSubTab === 'diagnostics' && (
            <div className="space-y-4 text-xs font-mono flex-1">
              <div className="grid grid-cols-2 gap-4 border-b border-slate-50 dark:border-neutral-850 pb-4">
                <div>
                  <span className="text-[10px] text-slate-400 uppercase tracking-wider block">Repository Version</span>
                  <span className="text-xs text-slate-800 dark:text-neutral-200 font-bold">{knowledgeSnapshot.metadata.repositoryVersion}</span>
                </div>
                <div>
                  <span className="text-[10px] text-slate-400 uppercase tracking-wider block">Snapshot Build Reason</span>
                  <span className="text-xs text-slate-800 dark:text-neutral-200 font-bold">{knowledgeSnapshot.metadata.buildReason}</span>
                </div>
              </div>
              
              <div className="border-b border-slate-50 dark:border-neutral-850 pb-4">
                <span className="text-[10px] text-slate-400 uppercase tracking-wider block mb-1">Active Snapshot Hash</span>
                <span className="text-[11px] bg-slate-50 dark:bg-neutral-950/30 p-2 rounded block truncate border border-slate-100 dark:border-neutral-850 text-slate-650 dark:text-neutral-300">
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-2 text-[10px] text-center bg-slate-50/50 border border-slate-100 p-2.5 rounded dark:bg-neutral-950/10 dark:border-neutral-850">
                  ...
                  <div className="space-y-1 border-l border-r border-slate-150 dark:border-neutral-850">
            ...
            <div className="flex-1 overflow-y-auto space-y-2 max-h-[350px]">
              {history.length === 0 ? (
                ...
                history.map((snap, idx) => (
                  <div 
                    key={idx}
                    className="p-3 border border-slate-100 dark:border-neutral-850 rounded bg-slate-50/20 text-xs font-mono flex items-center justify-between"
                  >
                    <div className="min-w-0">
                      <div className="flex items-center space-x-2">
                        <span className="text-indigo-500 font-bold">V{snap.metadata.repositoryVersion}</span>
                        <span className="text-slate-700 dark:text-neutral-300 font-semibold truncate max-w-[200px]">{snap.metadata.buildReason}</span>
                      </div>
                      <span className="text-[10px] text-slate-400">{formatTime(snap.metadata.buildStarted)}</span>
                    </div>
                    <div className="text-right text-[10px] text-slate-500 dark:text-neutral-400 shrink-0">
            ...
            <div className="flex-1 overflow-y-auto space-y-2 max-h-[350px]">
              {capturedEvents.length === 0 ? (
                ...
                capturedEvents.map((evt, idx) => (
                  <div 
                    key={idx}
                    className="p-3 border border-slate-100 dark:border-neutral-850 rounded bg-slate-50/25 dark:bg-neutral-950/10 text-xs font-mono"
                  >
                    ...
                    <div className="text-[10px] text-slate-500 dark:text-neutral-400 grid grid-cols-2 gap-1 mb-1.5">
                      <span>Source: <strong className="text-slate-600 dark:text-neutral-300">{evt.source}</strong></span>
                      <span>Entity ID: <strong className="text-slate-650 dark:text-neutral-350 truncate block">{evt.entityId}</strong></span>
                    </div>
                    {evt.payload && (
                      <pre className="text-[9px] bg-slate-50 dark:bg-neutral-950/40 p-1.5 rounded overflow-x-auto text-slate-600 dark:text-neutral-400 border border-slate-100 dark:border-neutral-850">
